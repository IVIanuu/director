...
import com.ivianuu.director.sample.controller.SimpleDialogController
...
//                setRoot(HomeController().toTransaction())
            ...
            setBackstack(
                listOf(
                    ...
                    SimpleDialogController().toTransaction()
            ...
            Handler().postDelayed(Runnable {
                setBackstack(
                    listOf(
                        backstack[0],
                        backstack[1].controller.toTransaction()
                            .changeHandler(FadeChangeHandler(removesFromViewOnPush = false)),
                        backstack[2]
                    ), true
                )
